...
const InlineEdit = ({ value, onChange, placeholder, className = "", type = "text", multiline = false, style={} }) => {
  // When printing or downloading PDF, inputs might look strange, but we apply custom styles so they look like text.
  if (multiline) {
      return (
          <textarea
              value={value}
              ...
              className={`bg-transparent border-0 outline-none resize-none hover:bg-black/5 focus:bg-white focus:ring-1 focus:ring-black text-inherit transition-colors rounded ${className} print:!bg-transparent print:!p-0 relative z-10 pointer-events-auto`}
  ...
  return (
      <input
          ...
          onChange={(e) => onChange(e.target.value)}
          placeholder={placeholder}
          className={`bg-transparent border-0 outline-none hover:bg-black/5 focus:bg-white focus:ring-1 focus:ring-black text-inherit transition-colors rounded w-full ${className} print:!bg-transparent print:!p-0 relative z-10 pointer-events-auto`}
          style={style}
          onPointerDown={(e) => e.stopPropagation()}
          onClick={(e) => e.stopPropagation()}
      />
                             ...
                             <div className="text-right space-y-1 w-64 shrink-0">
                                 ...
                                 <div className="flex flex-col gap-1 items-end">
                                     <div className="flex justify-between items-center w-full max-w-[200px]">
                                         ...
                                         <input type="date" value={date} onChange={e => setDate(e.target.value)} className="font-medium bg-transparent text-right outline-none hover:bg-black/5 focus:bg-white focus:ring-1 focus:ring-black rounded text-zinc-800 transition-colors w-32" />
                                     </div>
                                     <div className="flex justify-between items-center w-full max-w-[200px]">
