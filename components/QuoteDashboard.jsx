                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2 border-t border-zinc-100 pt-2">
                                        <div>
                                            <div className="flex justify-between items-center mb-1.5 text-[8px] text-zinc-500 uppercase font-bold tracking-wider">
                                                <span>Incluye</span>
                                                <button onClick={() => updateItem(item.id, 'includes', [...(item.includes || []), ''])} className="hover:text-black flex items-center gap-1 bg-zinc-100 px-1.5 py-0.5 rounded">
                                                    + Detalle
                                                </button>
                                            </div>
                                            {(item.includes || []).map((inc, idx) => (
                                                <div key={`inc-${idx}`} className="flex items-center gap-1 mb-1 relative group">
                                                    <input 
                                                        ...
                                                        className="flex-1 bg-zinc-50 border border-zinc-200/50 rounded-md p-1.5 text-[10px] focus:ring-1 focus:ring-black outline-none transition-shadow" 
                                                    ...
                                                    <button onClick={() => {
                                                        ...
                                                        newInc.splice(idx, 1);
                                                        updateItem(item.id, 'includes', newInc);
                                                    }} className="text-zinc-300 hover:text-red-500 px-1 font-bold shrink-0 transition-colors" title="Eliminar punto">
                                                        ×
                                                    </button>
                                                </div>
                                            ))}
                                        ...
                                        <div>
                                            <div className="flex justify-between items-center mb-1.5 text-[8px] text-zinc-500 uppercase font-bold tracking-wider">
                                                ...
                                                <button onClick={() => updateItem(item.id, 'excludes', [...(item.excludes || []), ''])} className="hover:text-black flex items-center gap-1 bg-zinc-100 px-1.5 py-0.5 rounded">
                                                    + Detalle
                                                </button>
                                            </div>
                                     ...
                                     {items.map((item, i) => (
                                         <tr key={item.id}>
                                             ...
                                             <td className="py-4 font-medium align-top">
                                                 <div className="mb-2">{item.name || 'Descripción del servicio...'}</div>
                                             ...
                                             <td className="py-4 text-center text-zinc-500 align-top">{item.quantity}</td>
                                             <td className="py-4 text-right text-zinc-500 align-top">${item.price.toFixed(2)}</td>
                                             <td className="py-4 text-right font-semibold align-top">${(item.price * item.quantity).toFixed(2)}</td>
                                         </tr>
                                     ))}
                                 </tbody>
                             </table>
