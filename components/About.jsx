  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        <div className="w-80 rounded-3xl min-[1024px]:w-96">
          <Image
            ...
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              ...
              >
                <Image
                  ...
                  className="w-7 mt-3"
                />
                <h3 className="my-4 font-semibold text-gray-700 dark:text-white leading-4">
                  {title}
                </h3>
            ...
            {toolsData.map((tool, index) => (
              ...
              >
                <Image
                  src={tool}
                  alt="Tool"
                  className="w-5 sm:w-7 dark:invert contrast-200 brightness-90 grayscale"
                />
              </li>
            ))}
          </ul>
